      ...
      case "rivers":
        markers.push(L.marker([37.181,22.462]).bindPopup(`
          <div>
            ...
            <img src="" alt="Evrotas-River-Greece.jpg" style="width:100%;margin:10px;border-radius:8px;">
            <img src="" alt="towns-menu.jpg" style="width:100%;margin:10px;border-radius:8px;">
